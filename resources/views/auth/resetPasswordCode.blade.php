        ...
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-gray-400 leading-relaxed">
                    Verify your access to the secure logic vault via the encrypted token sent to your Email.
                </p>
            </div>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-1">
                    Token dispatched to <span class="text-blue-400">{{ session('userEmail') ?? 'Password Node' }}</span>
                </p>
            </div>

            <form method="POST" action="{{ url('/verify-reset-password') }}" class="space-y-6" id="otp-form">
                {{ csrf_field() }}
