    ...
    <div class="w-full max-w-4xl animate-in fade-in zoom-in duration-300">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 px-2 gap-4">
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm font-medium">Manage your vault identity and security. <span
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                {{-- ඉහළ z-index එකක් පවත්වා ගැනීමට මෙහි 'z-20' එකතු කර ඇත --}}
                <div class="glass-card bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 relative z-20">
                    ...
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="relative"> {{-- Dropdown එක නිවැරදිව position වීමට මෙය 'relative' විය යුතුයි --}}
                                ...
                                {{-- Suggestion Dropdown: මෙහි z-[1000] සහ shadow අගයන් වැඩිකර ඇත --}}
                                <div id="suggestions"
                ...
                {{-- Security Section: පහළ කාඩ් එකේ z-index එක 'z-10' ලෙස තබා ඇත --}}
