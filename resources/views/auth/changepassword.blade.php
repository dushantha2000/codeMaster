...
@section('content')
    <div class="flex flex-col md:flex-row w-full max-w-4xl glass-card rounded-3xl overflow-hidden shadow-2xl border border-white/5" 
        ...
        <div class="hidden md:flex md:w-1/2 relative  items-center justify-center p-12 overflow-hidden border-r border-white/5 image-glow-blue">
            <div class="relative z-10 text-center">
                ...
                <h2 class="text-3xl font-bold text-white mb-4">Secure Your Vault</h2>
                <p class="text-gray-400 leading-relaxed text-sm">Choose a strong, unique password to protect your snippets and data.</p>
            </div>
            <div class="absolute -bottom-10 -left-10 w-40 h-40 bg-blue-600/5 rounded-full blur-3xl"></div>
        </div>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-1">Please update your credentials below.</p>
            </div>
            ...
            <form action="{{ url('update-password') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-400 mb-1.5 ml-1">Confirm Your Email</label>
