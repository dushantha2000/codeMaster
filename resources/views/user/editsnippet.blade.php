    ...
    <body class="text-gray-100" x-data="snippetEditor()" x-cloak>
                ...
                <div class="flex items-center gap-3 md:gap-4 shrink-0">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-base font-semibold text-[#EDEDED] tracking-tight hide-on-mobile">
                            ...
                            <span class="text-purple-500/60 text-[10px] ml-1 font-medium tracking-normal">Pro</span>
                        </h1>
                    </div>
                </div>
                ...
                <div class="flex-1 flex items-center justify-center gap-2 md:gap-3 max-w-2xl px-2 min-w-0">
                    <div class="text-center min-w-0 flex-1">
                        ...
                        <div class="hidden md:block relative group">
                            <p class="text-[11px] text-[#71717A] truncate px-2 cursor-help"
                ...
                <div class="flex items-center gap-2 md:gap-3 shrink-0">
                    <div class="flex items-center gap-2 border-l border-white/10 pl-2 md:pl-3">
                        <button type="submit"
                            ...
                            <span class="hidden md:inline text-xs font-semibold">Save Changes</span>
                        </button>
                ...
                <aside
                    ...
                    <div class="p-6 border-b border-white/5 bg-white/[0.01]">
                        <div class="flex justify-between items-center mb-6">
                            <h2
                                class="text-[9px] font-bold tracking-normal text-[#3F3F46] flex items-center gap-2">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-[10px] px-2 py-0.5 rounded-md bg-purple-500/10 text-purple-400 font-bold border border-purple-500/20"
                                    x-text="files.length"></span>
                            </div>
                        </div>

                        <button type="button" @click="showAddFileModal = true; mobileMenuOpen = false"
                            class="w-full bg-white/5 hover:bg-white/10 border border-white/5 text-[#EDEDED] px-4 py-3 rounded-xl font-bold text-[10px] tracking-normal transition-all flex items-center justify-center gap-2 shadow-xl">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 overflow-y-auto p-3 space-y-2 custom-scrollbar">
                        <template x-for="(file, index) in files" :key="index">
                            <div @click="activeTab = index; mobileMenuOpen = false"
                                :class="activeTab === index ? 'bg-purple-500/5 text-[#EDEDED] border-purple-500/20 shadow-[0_0_20px_rgba(168,85,247,0.05)]' :
                                ...
                                <div class="flex items-center gap-3 flex-1 min-w-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div x-text="file.name || 'untitled.php'"
                                            class="text-[11px] font-bold truncate tracking-tight"></div>
                                        <div x-text="file.path || 'root'"
                                            class="text-[9px] opacity-40 truncate font-mono tracking-tighter"
                                            :class="activeTab === index ? 'text-purple-400' : ''"></div>
                                    </div>
                                </div>
                        ...
                        <div x-show="activeTab === index" class="h-full flex flex-col">
                            ...
                            <div class="p-6 md:p-8 border-b border-white/5 bg-white/[0.01]">
                                <div class="file-meta-mobile grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                    <div>
                                        <label
                                            class="text-[9px] font-bold text-[#3F3F46] tracking-normal block mb-3 flex items-center gap-2 ml-1">
                                        ...
                                        <input type="text" x-model="file.name" name="file_names[]" required
                                            ...
                                            class="w-full bg-[#050505] border border-white/5 rounded-2xl px-5 py-3.5 text-xs text-[#EDEDED] focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500/40 outline-none transition-all placeholder-[#3F3F46] shadow-inner">
                                    </div>
                                    <div>
                                        <label
                                            class="text-[9px] font-bold text-[#3F3F46] tracking-normal block mb-3 flex items-center gap-2 ml-1">
                                ...
                                <!-- Quick Stats -->
                                <div class="flex gap-6 mt-6 text-[9px] text-[#3F3F46] font-black uppercase tracking-[0.2em] ml-1">
                                    <div class="flex items-center gap-2">
                            ...
                            <div class="flex-1 relative bg-[#030303] overflow-hidden">
                                ...
                                <div x-show="showLineNumbers"
                                    class="absolute left-0 top-0 bottom-0 w-10 bg-white/[0.01] border-r border-white/5 text-[#3F3F46] text-[11px] code-font pt-6 pr-3 select-none pointer-events-none overflow-hidden text-right">
        ...
        <div x-show="showInitialModal" x-cloak
            ...
            <div @click.away="false" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="mb-10 relative">
                    <h3 class="text-4xl font-bold text-[#EDEDED] mb-3 tracking-tighter">
                        Archive metadata
                    </h3>
                    <p class="text-[10px] font-bold tracking-normal text-[#3F3F46]">Synchronize your vault snippet with secure metadata.</p>
                </div>

                <div class="space-y-6 relative">
                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Archive title</label>
                        ...
                        <p x-show="projectValidation.title" class="text-[10px] text-red-500 mt-2 font-bold uppercase tracking-widest"
                            x-text="projectValidation.title"></p>
                    </div>

                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">
                            Secure description
                        </label>
                        <textarea x-model="projectInfo.description" rows="3"
                            placeholder="Define the scope of this logic..."
                            class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-sm text-[#EDEDED] outline-none focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500/50 transition-all shadow-inner resize-none placeholder-[#3F3F46]"
                            :class="{ 'border-red-500/30': projectValidation.description }"></textarea>
                        <p x-show="projectValidation.description" class="text-[10px] text-red-500 mt-2 font-bold uppercase tracking-widest"
                            x-text="projectValidation.description"></p>
                    </div>

                    <div class="grid grid-cols-2 gap-6 relative">
                        <div>
                            <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Language</label>
                            <div class="relative">
                                <select x-model="projectInfo.language"
                                    class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-xs text-[#EDEDED] outline-none focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500/50 transition-all cursor-pointer shadow-inner appearance-none">
                        ...
                        <div>
                            <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Category</label>
                            @if ($categories->isEmpty())
                                <div class="h-[54px] flex items-center px-5 bg-[#0A0A0A] rounded-2xl border border-dashed border-white/10">
                                    <a href="{{ url('/create-new') . '?type=category' }}"
                                        class="text-[10px] text-purple-400 hover:text-purple-300 font-bold tracking-normal transition-colors">Invoke category</a>
                                </div>
                            @else
                ...
                <div class="flex gap-4 mt-12 relative">
                    <a href="{{ isset($snippet) ? url('/my-snippets') : url('/') }}"
                        class="flex-1 bg-white/5 hover:bg-white/10 text-[#71717A] hover:text-[#EDEDED] px-6 py-4 rounded-2xl text-[10px] font-bold tracking-normal transition-all border border-white/5 text-center flex items-center justify-center">
                        Abort
                    </a>
                    <button type="button" @click="submitProjectInfo"
                        class="flex-1 btn-primary px-6 py-4 rounded-2xl text-[10px] font-bold tracking-normal h-[54px]">
                        Initialize
                    </button>
                </div>
            </div>
        ...
        <div x-show="showProjectModal" x-cloak @click.self="showProjectModal = false"
            ...
            <div @click.away="showProjectModal = false" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center justify-between mb-10 relative">
                    <h3 class="text-3xl font-bold text-[#EDEDED] flex items-center gap-3 tracking-tighter">
                        Archive metadata
                    </h3>
                ...
                <div class="space-y-6 relative">
                    <div>
                        ...
                        <input type="text" x-model="projectInfo.title" required placeholder="e.g. Auth Protocol"
                            class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-sm text-[#EDEDED] focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500/50 outline-none transition-all shadow-inner placeholder-[#3F3F46]">
                    </div>

                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Secure description</label>
                        <textarea x-model="projectInfo.description" required rows="3" placeholder="Define the scope..."
                            class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-sm text-[#EDEDED] focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500/50 outline-none transition-all resize-none shadow-inner placeholder-[#3F3F46]"></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Language</label>
                            <select x-model="projectInfo.language"
                                class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-xs text-[#EDEDED] outline-none focus:ring-4 focus:ring-purple-500/10 transition-all cursor-pointer shadow-inner appearance-none">
                                <option value="laravel">Laravel</option>
                                <option value="tailwind">Tailwind CSS</option>
                                <option value="react">React</option>
                                <option value="vue">Vue.js</option>
                        ...
                        <div>
                            ...
                            @if ($categories->isEmpty())
                                <div class="h-[54px] flex items-center px-5 bg-[#0A0A0A] rounded-2xl border border-dashed border-white/10">
                                    <span class="text-[10px] text-purple-400 font-bold tracking-normal transition-colors">Invoke category</span>
                                </div>
                            @else
                                <select x-model="projectInfo.category"
                                    class="w-full bg-[#0A0A0A] border border-white/5 rounded-2xl px-5 py-4 text-xs text-[#EDEDED] outline-none focus:ring-4 focus:ring-purple-500/10 transition-all cursor-pointer shadow-inner appearance-none">
                ...
                <div class="flex gap-4 mt-12 relative">
                    <button type="button" @click="showProjectModal = false"
                        class="flex-1 bg-white/5 hover:bg-white/10 text-[#71717A] hover:text-[#EDEDED] px-6 py-4 rounded-2xl text-[10px] font-bold tracking-normal transition-all border border-white/5">
                        Cancel
                    </button>
                    <button type="button"
        ...
        <div x-show="showAddFileModal" x-cloak @click.self="showAddFileModal = false"
            ...
            <div @click.away="showAddFileModal = false" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="space-y-6 relative">
                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Entity name</label>
                    ...
                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-3 block ml-1">Relative path</label>
                    ...
                    <!-- Quick Templates -->
                    <div>
                        <label class="text-[10px] font-bold text-[#71717A] tracking-normal mb-4 block ml-1">Logic archetypes</label>
                        <div class="grid grid-cols-3 gap-3">
                            <button type="button" @click="newFile.name = 'index.php'"
                                class="px-3 py-3 bg-[#0A0A0A] hover:bg-purple-500/10 rounded-xl text-[10px] font-bold tracking-normal text-[#A1A1AA] hover:text-purple-400 transition-all border border-white/5 hover:border-purple-500/30">
                                Php
                            </button>
        ...
        <div x-show="showSettings" x-cloak @click.self="showSettings = false"
            ...
            <div @click.away="showSettings = false" x-transition
                ...
                <h3 class="text-xl font-semibold mb-6 flex items-center gap-3">
                    ...
                    <span class="text-[#EDEDED]">Editor Settings</span>
                </h3>

                <div class="space-y-3">
                    <div class="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg border border-white/5">
                        <span class="text-sm font-medium text-[#EDEDED]">Line Numbers</span>
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" x-model="showLineNumbers" class="sr-only peer">
                            <div
                                class="w-10 h-5 bg-white/10 peer-focus:ring-2 peer-focus:ring-purple-500/20 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-purple-500/60">
                            </div>
                        </label>
                    </div>

                    <div class="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg border border-white/5">
                        <span class="text-sm font-medium text-[#EDEDED]">Auto-save</span>
                        <label class="relative inline-flex items-center cursor-pointer">
                ...
                <button @click="showSettings = false"
                    class="w-full btn-primary text-white px-6 py-2.5 rounded-lg text-sm font-semibold mt-8 transition-all">
                    Save Changes
                </button>
            </div>
        </div>
