        ...
        <template x-if="true">
            <div>
                ...
                <div x-show="showInitialModal" x-cloak
                    ...
                    <div
                        class="glass-card rounded-2xl p-8 md:p-10 w-full max-w-xl shadow-2xl border border-white/10 animate-in zoom-in-95 duration-300">
                        <div class="mb-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <p x-show="projectValidation.title" class="text-xs text-red-500 mt-1 font-medium"
                            ...
                            <div>
                                ...
                                <p x-show="projectValidation.description" class="text-xs text-red-500 mt-1 font-medium"
                            ...
                            <div class="grid grid-cols-2 gap-6">                                <div>
                                ...
                                <div>
                                    ...
                                    @if ($categories->isEmpty())
                                        <div
                                            class="h-[46px] flex items-center px-4 bg-black/20 rounded-lg border border-dashed border-white/10">
                                            <a href="{{ url('/categories.index') }}"
                                                class="text-xs text-blue-500 hover:text-blue-400 font-bold transition-colors">Setup
                                                Category</a>
                                        </div>
                                    @else
                                    ...
                                    @endif
                                    <p x-show="projectValidation.category" class="text-xs text-red-500 mt-1 font-medium"
                                        x-text="projectValidation.category"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 mt-10">
                            <a href="{{ url('/') }}"
                                class="flex-1 bg-white/5 hover:bg-white/10 text-gray-500 hover:text-white px-6 py-3 rounded-lg text-sm font-bold transition-all border border-white/5 text-center">Cancel</a>
                            <button type="button" @click="submitProjectInfo"
                                class="flex-1 btn-primary px-6 py-3 rounded-lg text-sm font-bold h-[48px] shadow-lg shadow-blue-900/10">Start
                                Entry</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    <label class="text-xs font-bold text-gray-500 mb-2 block ml-1">Language</label>
                                    <select x-model="projectInfo.language"
                                        class="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:outline-none appearance-none">                                @foreach ($supportedLanguages as $key => $name)
                                            <option value="{{ $key }}">{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            return {
                ...
                handleTabKey(e, textarea) {
                    if (typeof CodeFormatter !== 'undefined') {
                        ...
                        // Fallback if CodeFormatter isn't loaded
                        if (e.key === 'Tab') {
                            e.preventDefault();
