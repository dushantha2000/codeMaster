...
<head>
    ...
    <style>
        ...
        /* Subtle Glow for the Image Side */
        .image-glow {
            background: radial-gradient(circle at center, rgba(59, 130, 246, 0.15) 0%, transparent 70%);
        }
    </style>
</head>
<body class="text-gray-100 flex items-center justify-center min-h-screen p-4" x-data="loginForm()" x-cloak>
    ...
    <div class="flex flex-col md:flex-row w-full max-w-4xl glass-card rounded-3xl overflow-hidden shadow-2xl border border-white/10">
        ...
        <div class="hidden md:flex md:w-1/2 relative bg-black/40 items-center justify-center p-12 overflow-hidden border-r border-white/5 image-glow">
            <div class="relative z-10 text-center">
                ...
                <p class="text-gray-400 leading-relaxed">The ultimate vault for your snippets and architectural patterns.</p>
            </div>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <form action="" method="POST" class="space-y-4">
                <div>
                    ...
                    <input type="email" placeholder="dev@codevault.com" class="input-field w-full rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600">
                </div>

                <div>
                    <div class="flex justify-between items-center mb-1.5 ml-1">
                        <label class="block text-xs font-medium text-gray-400">Password</label>
                        <a href="#" class="text-[11px] text-blue-400 hover:underline">Forgot?</a>
                    </div>
                    <input type="password" placeholder="••••••••" class="input-field w-full rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600">
                </div>

                <div class="flex items-center py-1">
                    <input type="checkbox" id="remember" class="w-4 h-4 rounded border-gray-700 bg-black/50 text-blue-600 focus:ring-0">
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-500 text-xs">
                    New to CodeVault? 
                    <a href="#" class="text-blue-400 hover:text-blue-300 font-semibold ml-1">Create an account</a>
                </p>
            </div>
        </div>
    </div>
