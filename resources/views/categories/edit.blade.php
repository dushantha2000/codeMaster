    ...
    <div
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-1">Update your category details</p>
            </div>

            {{-- Form --}}
            <form action="{{ url('/category-update') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                {{ csrf_field() }}
                ...
                <div>
                    ...
                    <input type="text" name="name" id="categoryName" value="{{ old('name', $category->category_name) }}"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreviewColor(color) {
                ...
                if (previewCard) {
                    // Remove all hover border classes
                    const borderClasses = ['hover:border-blue-500/30', 'hover:border-purple-500/30',
                        'hover:border-green-500/30', 'hover:border-yellow-500/30',
                        'hover:border-red-500/30', 'hover:border-pink-500/30',
                        'hover:border-indigo-500/30', 'hover:border-teal-500/30',
                        'hover:border-orange-500/30', 'hover:border-cyan-500/30',
                        'hover:border-emerald-500/30', 'hover:border-rose-500/30'];
                    
                    borderClasses.forEach(cls => previewCard.classList.remove(cls));
                    previewCard.classList.add(`hover:border-${color}-500/30`);

                    // Remove all hover bg classes
                    const bgClasses = ['hover:bg-blue-500/5', 'hover:bg-purple-500/5',
                        'hover:bg-green-500/5', 'hover:bg-yellow-500/5',
                        'hover:bg-red-500/5', 'hover:bg-pink-500/5',
                        'hover:bg-indigo-500/5', 'hover:bg-teal-500/5',
                        'hover:bg-orange-500/5', 'hover:bg-cyan-500/5',
                        'hover:bg-emerald-500/5', 'hover:bg-rose-500/5'];
                    
                    bgClasses.forEach(cls => previewCard.classList.remove(cls));
